...
var app = (function () {
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$9, 28, 4, 518);
    			attr_dev(button0, "class", "btn-si btn-google");
    			add_location(button0, file$9, 30, 4, 547);
    			attr_dev(button1, "class", "btn-si btn-facebook");
    			add_location(button1, file$9, 31, 4, 621);
    			attr_dev(button2, "class", "btn-si btn-linkedin");
    			add_location(button2, file$9, 32, 4, 699);
    			attr_dev(button3, "class", "btn-si btn-pinterest");
    			add_location(button3, file$9, 33, 4, 777);
    			attr_dev(button4, "class", "btn-si btn-github");
    			add_location(button4, file$9, 34, 4, 857);
    			attr_dev(div, "id", "signin");
    			add_location(div, file$9, 27, 2, 496);
    ...
    function instance$a($$self, $$props, $$invalidate) {
    	...
    	function perfil() {
    		fetch("/perfil").then(function (response) {
    			return response.text();
    		}).then(function (text) {
    			$$invalidate(0, texto = text);
    		});
    	}

    	onMount(perfil);
    	const click_handler = () => popup("google");
    	const click_handler_1 = () => popup("facebook");
    	const click_handler_2 = () => popup("linkedin");
    	const click_handler_3 = () => popup("pinterest");
    	const click_handler_4 = () => popup("github");
